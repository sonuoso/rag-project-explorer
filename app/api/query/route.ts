...
export async function POST(request: Request) {
    try {
        ...
        const answer = await retrieve(question); // call retrieve on question and get the answer string with relevant file paths and code chunks

        return NextResponse.json({ message: "Answer generated.", answer: answer });
    } catch (error) {
